...
export const SERVICES: Service[] = [
  {
    ...
    description: [
      { text: "Building " },
      { text: "responsive, scalable, and modern", em: true },
      { text: " web applications with clean architecture and exceptional user experiences." },
    ],
  },
  {
    icon: Database,
    ...
    description: [
      { text: "Designing optimized database solutions using " },
      { text: "PostgreSQL, MySQL, and Prisma ORM", em: true },
      { text: " for performance, scalability, and data integrity." },
    ],
  },
  {
    icon: Webhook,
    ...
    description: [
      { text: "Creating secure " },
      { text: "RESTful APIs", em: true },
      { text: " and integrating third-party services for seamless communication across applications." },
    ],
  },
  {
    icon: Gauge,
    ...
    description: [
      { text: "Improving application speed through " },
      { text: "code optimization, SEO, and Core Web Vitals", em: true },
      { text: " to deliver faster and smoother user experiences." },
    ],
  },
  {
    icon: ShoppingCart,
    ...
    description: [
      { text: "Developing secure " },
      { text: "e-commerce platforms", em: true },
      { text: " with authentication, shopping carts, order management, and payment integration." },
    ],
  },
  {
    icon: BrainCircuit,
    ...
    description: [
      { text: "Integrating " },
      { text: "AI-powered features", em: true },
      { text: " such as chat, automation, and intelligent workflows to enhance modern web applications." },
    ],
  },
];
